...
@ViewScoped
@ManagedBean
public class AddDisputante extends AbstractBean{
	...
	public String adicionar() {
		...
		disputante.setModalidade(modalidadeEscolhida);
		
		disputanteServices.save(disputante);
		
		reportarMensagemDeSucesso("Disputante adicionado com sucesso!");
